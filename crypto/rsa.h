...
long long *rsa_encrypt(char *message, const unsigned long message_size, const struct public_key *pub);
...
char *rsa_decrypt(const long long *message, const unsigned long message_size, const struct private_key *pub);
